...
const { DateTime } = require("luxon"); // for formatting date
...
AuthorSchema.virtual("date_of_birth_formatted").get(function () {
  return DateTime.fromJSDate(this.date_of_birth).toISODate(); // 'YYYY-MM_DD' format
});

// Virtual for author's date of death
AuthorSchema.virtual("date_of_death_formatted").get(function () {
  return DateTime.fromJSDate(this.date_of_death).toISODate(); // 'YYYY-MM_DD' format
});
